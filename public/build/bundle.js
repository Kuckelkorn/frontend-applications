...
var app = (function () {
    ...
    const tasteAPI = {
      ...
      apiKey: "b5fffe76fc584bf5ade693915de6603e"
    };
    ...
    const xScale = linear().range([0, width]);
    const yScale = band().range([0, height]).padding(0.1);
    ...
    function update(data){
      xScale.domain([0, max(data, (d) => d.value)]);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "id", "ingredient");
    			attr_dev(input, "type", "text");
    			add_location(input, file, 5, 2, 78);
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(button, "click", findRecipes, false, false, false);
    				mounted = true;
    			}
    		},
    		p: noop$1,
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ findRecipes });
    	return [];
    }
